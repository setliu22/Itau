...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("LOOKUP_TABLE_IN_USE"))
    parser.add_argument("--multichar-lookup", type=Path, default=Path("DONOTDELETE/multicharacter_substitution_lookup.parquet"))
    parser.add_argument("--ocr-lookup", type=Path, default=Path("LOOKUP_TABLE_IN_USE/ocr_confusable_approved.csv"))
    parser.add_argument("--exact-lookup", type=Path, default=Path("LOOKUP_TABLE_IN_USE/exact_lookalike_approved.csv"))
