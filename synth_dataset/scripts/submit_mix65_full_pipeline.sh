...
for MODEL_KEY in conv1d_baseline conv1d_bilstm conv1d_transformer conv1d_stacked_cross_attention conv1d_single_cross_attention conv1d_interaction_cnn_cosine conv1d_interaction_cnn_rich; do
