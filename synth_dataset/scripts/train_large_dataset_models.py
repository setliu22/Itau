...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--train", type=Path, default=Path("large_dataset/BETTER_TRAIN.parquet"))
    parser.add_argument("--test", type=Path, default=Path("large_dataset/BETTER_TEST.parquet"))
    parser.add_argument("--validation", type=Path, default=Path("large_dataset/BETTER_VALIDATION.parquet"))
    parser.add_argument("--output-dir", type=Path, default=Path("NEW_RESULTS"))
